...
__export(openai_compatibility_exports, {
  ...
  defineOpenaiCompatibleModel: () => defineOpenaiCompatibleModel,
...
function toRequestBody(model, request) {
  ...
  const mappedModelName = (0, import_utils.checkModelName)(model.name);
  const body = {
...
function defineOpenaiCompatibleModel(model, clientFactory) {
  const modelId = (0, import_utils.checkModelName)(model.name);
