import { CompletionChunk, ChatCompletionChoiceFinishReason, ChatCompletionResponse, ChatCompletionRequest } from '@mistralai/mistralai-gcp/models/components/index.js';
import { ModelReference, z, Part, GenerateRequest, ModelResponseData, ActionMetadata } from 'genkit';
