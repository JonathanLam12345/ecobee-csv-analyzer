...
import { ModelReference, GenerateRequest, ModelAction, CandidateData, ToolRequestPart, Role, MessageData, Part } from 'genkit/model';
import OpenAI from 'openai';
import { ChatCompletion, ChatCompletionChunk, ChatCompletionMessageToolCall, ChatCompletionRole, ChatCompletionMessageParam, ChatCompletionContentPart } from 'openai/resources/index.mjs';
...
declare function defineOpenaiCompatibleModel<C extends typeof OpenAIConfigSchema>(model: ModelReference<any>, clientFactory: (request: GenerateRequest<C>) => Promise<OpenAI>): ModelAction<C>;

export { OpenAIConfigSchema, defineOpenaiCompatibleModel, fromOpenAiChoice, fromOpenAiChunkChoice, fromOpenAiToolCall, toOpenAIRole, toOpenAiMessages, toOpenAiTextAndMedia, toRequestBody };
