...
import { predictModel } from "./predict.mjs";
...
function defineImagenModel(ai, name, client, options) {
  const modelName = `vertexai/${name}`;
  const model = SUPPORTED_IMAGEN_MODELS[name] || modelRef({
    name: modelName,
    info: {
      ...GENERIC_IMAGEN_INFO,
