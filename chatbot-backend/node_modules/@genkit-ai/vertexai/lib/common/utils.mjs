...
const TEST_ONLY = { setFakeDerivedOptions };
function setFakeDerivedOptions(options) {
  __fake_getDerivedOptions = options;
}
let __fake_getDerivedOptions;
...
async function getDerivedOptions(pluginName, options) {
